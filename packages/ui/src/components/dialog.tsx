    ...
    <BaseDialog.Root open={open} onOpenChange={onOpenChange}>
      <BaseDialog.Portal>
        ...
        <BaseDialog.Popup
          className={cn(
            panelClass,
            "fixed top-1/2 left-1/2 z-50 max-h-[88vh] w-[min(34rem,calc(100vw-3rem))] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-xl border border-border p-6 transition-[opacity,transform] data-ending-style:scale-98 data-ending-style:opacity-0 data-starting-style:scale-98 data-starting-style:opacity-0",
            className,
          )}
        >
